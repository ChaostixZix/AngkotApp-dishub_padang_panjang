...
class Angkot extends Controller
{
    ...
    {
        $data_insert = [];
        $input = ['nomor_registrasi', 'nama_pemilik', 'merk', 'jenis', 'tahun_pembuatan', 'isi_silinder', 'warna_kb', 'no_rangka', 'no_mesin', 'no_bpkb', 'bahan_bakar', 'warna_tnkb', 'no_pol_lama', 'berat_kb', 'jumlah_sumbu', 'jumlah_penumpang', 'rute'];
        foreach ($input as $a) {
