                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 18px; line-height: 28px; text-align: center; margin: 0;">
                                                <span
                                                    style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 24px;">New Pesanan!</span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 18px; color: #283C4B;">
                                            <div align="center" class="img-container center autowidth"
                                                 style="padding-right: 25px;padding-left: 25px;">
                                                <!--[if mso]>
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <p style="font-size: 12px; line-height: 24px; text-align: center; margin: 0;">
                                                <span style="font-size: 16px;"><strong><span
                                                            style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px;">#{{ $idPesanan }}</span></strong></span>
                                            </p>
                                            <p style="font-size: 12px; line-height: 24px; text-align: center; margin: 0;">
                                                <span mce-data-marked="1" style="font-size: 16px;"><strong><span
                                                            mce-data-marked="1"
                                                            style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; line-height: 24px; font-size: 16px;">{{ strtoupper($jenis_pesanan) }}</span></strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 12px; line-height: 21px; text-align: center; margin: 0;">
                                                <span
                                                    style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 14px;">Pesanan {{ strtoupper($jenis_pesanan) }} baru oleh {{ strtoupper($pemesan) }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div align="center" class="button-container"
                                            ...
                                            <tr>
                                                <td style="padding-top: 25px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:39pt; width:184.5pt; v-text-anchor:middle;"
                                                                 arcsize="8%" stroke="false" fillcolor="#3AAEE0">
                                                        <w:anchorlock/>
                                        ...
                                        <![endif]-->
                                        <div
                                            style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:20px;padding-right:20px;padding-bottom:30px;padding-left:20px;">
                                            <div
                                                ...
                                                <p style="font-size: 14px; line-height: 16px; text-align: center; margin: 0;">
                                                    <span
                                                        style="font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 14px; line-height: 16px;"><a
                                                            @if($jenis_pesanan == 'derek')
                                                            href="{{ route('derekInvoicePage') }}/{{ $idPesanan }}"
                                                            @elseif($jenis_pesanan == 'parkir')
                                                            href="{{ route('parkirInvoicePage') }}/{{ $idPesanan }}"
                                                            @endif
                                                            style="color: #3AAEE0;"
                                                            target="_blank"
                                                            title="example">Cek</a></span></p>
                                            </div>
                                        </div>
