        ...
        <div class="navbar-right">
            ...
            <div class="dropdown dropdown-profile">
                ...
                <div class="dropdown-menu dropdown-menu-right tx-13">
                    ...
                    <a href="{{ route('updateProfil') }}" class="dropdown-item"><i data-feather="edit-3"></i> Edit
                        Profile</a>
            ...
            @if(Session::has('username'))
                @if(Session::get('level') == 'admin')
                    <li class="nav-item with-sub">
                        ...
                        <ul class="navbar-menu-sub">
                            ...
                            <li class="nav-sub-item"><a href="{{ route('postAdmin') }}" class="nav-sub-link"><i
                                        class="fa fa-pencil-alt mg-r-15"></i>Posting</a></li>
                    ...
                    <li class="nav-item with-sub">
                        ...
                        <ul class="navbar-menu-sub">
                            ...
                            <li class="nav-sub-item"><a href="{{ route('parkirPesananPageAdmin') }}"
                                    ...
                                    Parkir</a></li>
                            <li class="nav-sub-item"><a href="{{ route('parkirPesananSearchPageAdmin') }}"
                                                        class="nav-sub-link"><i class="fa fa-search mg-r-15"></i>SearchPesanan Pak
                                </a></li>
                        </ul>
                    </li>
                @endif
                <li class="nav-item with-sub">
                    ...
                    <ul class="navbar-menu-sub">
                        ...
                        <li class="nav-sub-item"><a href="{{ route('aduanPageUser') }}" class="nav-sub-link"><i
                                    data-feather="alert-octagon"></i>Pengaduan</a></li>
                        {{--                            <li class="nav-sub-item"><a href="app-file-manager.html" class="nav-sub-link"><i data-feather="message-circle"></i>Inbox</a></li>--}}
                        {{--                            <li class="nav-sub-item"><a href="app-mail.html" class="nav-sub-link"><i data-feather="credit-card"></i>Kartu</a></li>--}}
                    </ul>
                </li>
