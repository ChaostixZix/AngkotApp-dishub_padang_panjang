...
<div class="modal modal fade" id="aduanTambahModal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered wd-sm-650" role="document">
        <div class="modal-content">
            <div class="modal-header pd-y-20 pd-x-20 pd-sm-x-30">
                <a href="" role="button" class="close pos-absolute t-15 r-15" data-dismiss="modal"
                ...
                <div class="media align-items-center">
                    <div class="media-body mg-sm-l-20">
                        <h4 class="tx-18 tx-sm-20 mg-b-2">Tambah Aduan</h4>
                    </div>
                </div><!-- media -->
            </div><!-- modal-header -->
            <div class="modal-body pd-sm-t-30 pd-sm-b-40 pd-sm-x-30">
                <div class="row row-sm mg-b-5">
                    <div class="col-sm">
                        <label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-5 tx-color-03">Judul
                            Aduan</label>
                        <input id="judulTambahAduan" type="text" class="form-control" placeholder="Judul Aduan">
                    </div><!-- col -->
                    <div class="col-sm-5 mg-t-20 mg-sm-t-0">
                        <label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-5 tx-color-03">Pengadu</label>
                        <input readonly id="pengaduTambahAduan" type="text" class="form-control" value="{{ \Illuminate\Support\Facades\Session::get('username') }}">
                    </div><!-- col -->
                </div>
                <div class="form-group mg-t-5">
                    <label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-5 tx-color-03">Tindakan</label>
                    <select readonly id="tindakanTambahAduan" class="custom-select">
                        <option value="0">Biasa</option>
                        <option value="1">Penting</option>
                    </select>
                </div><!-- col -->
{{--                <div class="form-group mg-t-5">--}}
{{--                    <label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-5 tx-color-03">Tanggal</label>--}}
{{--                    <input id="tanggalTambahAduan" type="text" class="form-control">--}}
{{--                </div><!-- col -->--}}
                <div class="form-group mg-t-5">
                    <label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-5 tx-color-03">Pengadu</label>
                    <input id="gambarTambahAduan" type="file" class="form-control">
                </div><!-- col -->
                <div class="form-group mg-t-5">
                    <label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-5 tx-color-03">Konten</label>
                    <textarea rows="9" id="kontenTambahAduan" type="text" class="form-control"
                              placeholder="Konten Aduan"></textarea>
                </div>
            </div><!-- modal-body -->
            <div class="modal-footer tx-center2 pd-x-20 pd-y-15">
                {{--                    <button type="button" class="btn btn-white" data-dismiss="modal">Cancel</button>--}}
                                    <button type="button" onclick="submitAduan()" class="btn btn-primary">Submit</button>
            </div>
        </div><!-- modal-content -->
    </div><!-- modal-dialog -->
</div>
                ...
                <div class="card mg-b-10">
                    <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
                        <div>
                            ...
                            <p class="tx-13 tx-color-03 mg-b-0">List aduan yang telah anda buat</p>
                        </div>
                        <div class="d-flex mg-t-20 mg-sm-t-0">
                            <div class="btn-group flex-fill">
                                <button class="btn btn-white btn-xs active" data-toggle="modal" data-target="#aduanTambahModal"><i class="fa fa-plus"></i> Tambah</button>
                            </div>
                        </div>
                    </div><!-- card-header -->
                    <div class="card-body ">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h6 class="mg-b-0">Data Aduan Anda</h6>
...
<script>
    ...
    function submitAduan() {
        ...
        formdata.append('inputTindakan', tindakan);
        formdata.append('pengadu', pengadu);
        formdata.append('inputGambar', gambar);
        formdata.append('inputAduan', konten);
        formdata.append('_token', _token);

        if (judul === '' || tindakan === null || pengadu == null || gambar === null || konten === '') {
