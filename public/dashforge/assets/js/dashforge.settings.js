...
//       if(hasMode) {
//         $('head').append('<link id="dfMode" rel="stylesheet" href="dashforge/assets/css/skin.'+hasMode+'.css">')
...
//       if(hasSkin) {
//         $('head').append('<link id="dfSkin" rel="stylesheet" href="dashforge/assets/css/skin.'+hasSkin+'.css">')
...
//         if($('#dfMode').length === 0) {
//           if($('#dfSkin').length === 0) {
//             $('head').append('<link id="dfMode" rel="stylesheet" href="dashforge/assets/css/skin.'+mode+'.css">');
//           } else {
//             $('<link id="dfMode" rel="stylesheet" href="dashforge/assets/css/skin.'+mode+'.css">').insertBefore($('#dfSkin'));
//           }
//         } else {
//           $('#dfMode').attr('href', 'dashforge/assets/css/skin.'+mode+'.css');
//         }
//
...
//
//       if($('#dfSkin').length === 0) {
//         $('head').append('<link id="dfSkin" rel="stylesheet" href="dashforge/assets/css/skin.'+skin+'.css">')
//       } else {
//         $('#dfSkin').attr('href', 'dashforge/assets/css/skin.'+skin+'.css');
//       }
//
